...
// Activation Logic
router.post("/addActivationLogic",authMiddelWere, addActivationLogic);
router.get("/fetchAllActivationPlans",authMiddelWere,fetchAllActivationPlans)

router.get("/plansShowOEMandDistributor",plansShowOEMandDistributor)

router.post("/fetchManufacturerOnBasisOsState",authMiddelWere, fetchManufacturerOnBasisOsState);
router.post("/ActivationWalletToManufactur", authMiddelWere,ActivationWalletToManufactur);
router.get("/fetchAssignActivationWallet",authMiddelWere,fetchAssignActivationWallet);
router.get("/fetchManufacturActivatioWallet",authMiddelWere,fetchManufacturActivatioWallet);
router.post("/manufacturCanAddPriceAndNoOfWallet",authMiddelWere,manufacturCanAddPriceAndNoOfWallet)
