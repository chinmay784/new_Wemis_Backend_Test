...
function WlpElementAssignList() {
  ...
  const fetchAssignedData = async () => {
    try {
      const response = await axios.post(
        "http://localhost:4000/api/wlp/fetchAllDataRelatedtoAssignElements",
        {},
  ...
  const fetchElementsAndDealers = async () => {
    try {
      const response = await axios.post(
        "http://localhost:4000/api/wlp/fetchAssignElement",
        {},
        { headers: { Authorization: `Bearer ${tkn}` } }
      );
  ...
  const handleAssign = async () => {
    ...
    try {
      await axios.post(
        "http://localhost:4000/api/wlp/AssignElements",
