...
function SuperAdminAssignElement() {
    ...
    const fetchData = async () => {
        try {
            const response = await axios.post(
                "http://localhost:4000/api/superadmin/fetchAllAdmins",
                {},
                {
                    headers: {
    ...
    const fetchCopData = async () => {
        try {
            const response = await axios.post(
                "http://localhost:4000/api/superadmin/fetchAllCopNo",
                {},
                {
                    headers: {
                        Authorization: `Bearer ${tkn}`,
    ...
    const fetchAssignedElements = async () => {
        try {
            const response = await axios.post(
                "http://localhost:4000/api/superadmin/fetchSuperAdminAssignElement",
                {},
                {
                    headers: {
                        Authorization: `Bearer ${tkn}`,
    ...
    const handleAssign = async () => {
        ...
        try {
            await axios.post(
                "http://localhost:4000/api/superadmin/assignElement",
