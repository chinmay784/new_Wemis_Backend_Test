...
function ElementTypePage() {
  ...
  const fetchData = async () => {
    try {
      ...
      setData(response.data.fetchAllType)
        ...
        <table className="min-w-full text-gray-200">
          <thead>
            <tr className="bg-yellow-400 text-black text-sm uppercase tracking-wide">
              ...
              <th className="py-3 px-6 text-left">Sim</th>
              ...
              filteredData.map((item, index) => (
                ...
                >
                  ...
                  <td className="py-4 px-6 text-lg">
                    {Number(item.sim) !== 0 ? item.sim : "Not Required" }
                  </td>
...
export default ElementTypePage;
