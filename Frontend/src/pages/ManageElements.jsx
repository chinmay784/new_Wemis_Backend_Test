...
const ManageElements = () => {
  ...
  const addButton = async () => {
    ...
    try {
      ...
      await axios.post(
        "http://localhost:4000/api/superadmin/addElementCheckBox",
        { checkBoxoxName },
        {
          headers: {
  ...
  async function handleBrandSubmit(e) {
    ...
    try {
      setLoading(true);
      await axios.post(
        "http://localhost:4000/api/superadmin/createBrand",
        { brandName },
        {
          headers: {
            Authorization: `Bearer ${tkn}`,
  ...
  async function handleCategorySubmit(e) {
    ...
    try {
      setLoading(true);
      await axios.post(
        "http://localhost:4000/api/superadmin/createElementCategory",
  ...
  const fetchBrands = async () => {
    try {
      const response = await axios.post(
        "http://localhost:4000/api/superadmin/fetchAllBrands",
        {},
        {
          headers: {
            Authorization: `Bearer ${tkn}`,
  ...
  const fetchcategory = async () => {
    try {
      const response = await axios.post(
        "http://localhost:4000/api/superadmin/fetchAllCategory",
        {},
        {
          headers: {
            Authorization: `Bearer ${tkn}`,
  ...
  async function handleElementSubmit(e) {
    ...
    try {
      setLoading(true);
      await axios.post(
        "http://localhost:4000/api/superadmin/createElement",
  ...
  const fetchCostumize = async () => {
    try {
      const responsedata = await axios.post(
        "http://localhost:4000/api/superadmin/fetchAllElementCheckBox",
        {},
        {
          headers: {
            Authorization: `Bearer ${tkn}`,
  ...
  const fetchData = async () => {
    try {
      const response = await axios.post(
        "http://localhost:4000/api/superadmin/fetchAllElement",
        {},
        {
          headers: {
            Authorization: `Bearer ${tkn}`,
  ...
  const handleElementtypeSubmit = async (e) => {
    ...
    try {
      const response = await axios.post(
        "http://localhost:4000/api/superadmin/addElementType",
        {
  ...
  const handleElementModelSubmit = async (e) => {
    ...
    try {
      await axios.post(
        "http://localhost:4000/api/superadmin/addDeviceModel",
        {
  ...
  const fetchmodelData = async () => {
    try {
      const response = await axios.post(
        "http://localhost:4000/api/superadmin/fetchAllElementType",
        {},
        {
          headers: {
            Authorization: `Bearer ${tkn}`,
  ...
  const handleDevicePartSubmit = async (e) => {
    ...
    try {
      setLoading(true);
      await axios.post(
        "http://localhost:4000/api/superadmin/addDevicePart",
        {
  ...
  const fetchpartData = async () => {
    try {
      const response = await axios.post(
        "http://localhost:4000/api/superadmin/fetchModelElementData",
        {},
        {
          headers: {
            Authorization: `Bearer ${tkn}`,
  ...
  const fetchTacData = async () => {
    try {
      const response = await axios.post(
        "http://localhost:4000/api/superadmin/fetchAllDeviceData",
        {},
        {
          headers: {
            Authorization: `Bearer ${tkn}`,
  ...
  const handleTACSubmit = async (e) => {
    ...
    try {
      setLoading(true);
      await axios.post(
        "http://localhost:4000/api/superadmin/addTacNumber",
        {
  ...
  const fetchcopData = async () => {
    try {
      const response = await axios.post(
        "http://localhost:4000/api/superadmin/fetchAllTacNo",
        {},
        {
          headers: {
            Authorization: `Bearer ${tkn}`,
  ...
  const handleCOPSubmit = async (e) => {
    ...
    try {
      setLoading(true);
      await axios.post(
        "http://localhost:4000/api/superadmin/addCopNumber",
        {
