...
function DealerOem() {
  ...
  const fetchDistributors = async () => {
    try {
      const res = await axios.post(
        "http://localhost:4000/api/manufactur/fetchOems",
        {},
  ...
  const fetchDealers = async () => {
    try {
      const res = await axios.post(
        "http://localhost:4000/api/manufactur/fetchDelerUnderOems",
        {},
        { headers: { Authorization: `Bearer ${tkn}` } }
      );
  ...
  const handleCreateSubmit = async (e) => {
    ...
    try {
      await axios.post(
        "http://localhost:4000/api/manufactur/createDelerUnderOems",
        newDealer,
        { headers: { Authorization: `Bearer ${tkn}` } }
      );
  ...
  const handleDelete = async (id) => {
    ...
    if (confirm.isConfirmed) {
      try {
        ...
        await axios.post(
          "http://localhost:4000/api/manufactur/deleteDelerUnderOems",
...
const fetchDealerById = async (id) => {
  try {
    setLoadingEdit(true);
    const res = await axios.post(
      "http://localhost:4000/api/manufactur/getDelerUnderOemsById",
      { oemsId: id },
      { headers: { Authorization: `Bearer ${tkn}` } }
    );
  ...
  try {
    await axios.post(
      "http://localhost:4000/api/manufactur/editDelerOem",
      {
        ...editData,
