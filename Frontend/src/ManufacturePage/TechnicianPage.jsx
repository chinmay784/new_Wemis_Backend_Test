...
// API Endpoints
const CREATE_TECHNICIAN_API = "http://localhost:4000/api/manufactur/createTechnician";
const FETCH_DISTRIBUTORS_API = "http://localhost:4000/api/manufactur/fetchAllDistributors";
const FETCH_DEALERS_API = "http://localhost:4000/api/manufactur/fetchAlldelersUnderDistributor"; 
const FETCH_TECHNICIANS_API = "http://localhost:4000/api/manufactur/fetchAllTechnicien";
