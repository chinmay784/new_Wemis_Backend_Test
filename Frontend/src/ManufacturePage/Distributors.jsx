...
function Distributors() {
  ...
  const fetchDistributors = async () => {
    try {
      const response = await axios.post(
        "http://localhost:4000/api/manufactur/fetchDistributor",
        {},
  ...
  const handleDelete = async (id) => {
    Swal.fire({
      ...
      if (result.isConfirmed) {
        try {
          const response = await axios.post(
            "http://localhost:4000/api/manufactur/deleteDistributor",
            { id: id },
            { headers: { Authorization: `Bearer ${tkn}` } } // Fixed template literal
          );
  ...
  const handleEditClick = async (id) => {
    ...
    try {
      const response = await axios.post(
        "http://localhost:4000/api/manufactur/fetchDistributorById",
        { distributorId: id },
  ...
  const handleSave = async (e) => {
    ...
    try {
      const response = await axios.post(
        "http://localhost:4000/api/manufactur/editDistributor",
  ...
  const handleCreateSubmit = async (e) => {
    ...
    try {
      ...
      const response = await axios.post(
        "http://localhost:4000/api/manufactur/createDistributor",
        formData,
        {
          headers: {
