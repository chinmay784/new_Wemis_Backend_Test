...
function OEM() {
    ...
    const handleDelete = async (id) => {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                try {
                    const response = await axios.post(
                        "http://localhost:4000/api/manufactur/deleteOems",
    ...
    const handleEditClick = async (id) => {
        ...
        try {
            const response = await axios.post(
                "http://localhost:4000/api/manufactur/getOemsById",
                { oemsId: id },
                { headers: { Authorization: `Bearer ${tkn}` } }
            );
    ...
    const handleSave = async (e) => {
        ...
        try {
            const response = await axios.post(
                "http://localhost:4000/api/manufactur/editOemsById",
    ...
    const handleCreate = async (e) => {
        ...
        try {
            const response = await axios.post(
                "http://localhost:4000/api/manufactur/createOem",
                createData,
                { headers: { Authorization: `Bearer ${tkn}` } }
            );
