...
const SUBSCRIPTION_CREATE_API =
  "http://localhost:4000/api/manufactur/createNewSubscription";
const FETCH_SUBSCRIPTIONS_API =
  "http://localhost:4000/api/manufactur/fetchAllSubscriptionPlans";
const FIND_SUBSCRIPTION_BY_ID_API =
  "http://localhost:4000/api/manufactur/findSubScriptionById";
const EDIT_SUBSCRIPTION_API =
  "http://localhost:4000/api/manufactur/editSubscriptionById";
