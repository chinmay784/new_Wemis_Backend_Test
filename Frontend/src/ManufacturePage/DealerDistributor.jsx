...
function DealerDistributor() {
    ...
    const fetchDealers = async () => {
        try {
            const res = await axios.post(
                "http://localhost:4000/api/manufactur/fetchDelerDistributor",
                {},
                { headers: { Authorization: `Bearer ${tkn}` } }
            );
    ...
    const handleCreateSubmit = async (e) => {
        ...
        try {
            await axios.post(
                "http://localhost:4000/api/manufactur/createDelerUnderDistributor",
                newDealer,
                { headers: { Authorization: `Bearer ${tkn}` } }
            );
    ...
    const handleDelete = async (id) => {
        ...
        if (confirm.isConfirmed) {
            try {
                ...
                await axios.post(
                    "http://localhost:4000/api/manufactur/deleteDelerDistributor",
