...
const ELEMENT_DATA_API = " http://localhost:4000/api/manufactur/fetchElementData";
const AVAILABLE_BARCODES_API = " http://localhost:4000/api/manufactur/fetchAllBarCodeNumber";
const DISTRIBUTOR_API = " http://localhost:4000/api/manufactur/findDistributorUnderManufactur";
const OEM_API = " http://localhost:4000/api/manufactur/findOemUnderManufactur";
const DEALER_UNDER_DISTRIBUTOR_API = " http://localhost:4000/api/manufactur/findDelerUnderDistributor";
const DEALER_UNDER_OEM_API = " http://localhost:4000/api/manufactur/findDelerUnderOem";
const ALLOCATE_API = " http://localhost:4000/api/manufactur/AllocateBarCode";
const ALLOCATED_DATA_API = " http://localhost:4000/api/manufactur/fetchAllAllocatedBarcode";
