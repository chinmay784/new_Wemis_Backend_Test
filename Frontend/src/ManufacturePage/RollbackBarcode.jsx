...
const ROLLBACK_API = "http://localhost:4000/api/manufactur/rollBackAllocatedBarCode";
const ELEMENT_API = "http://localhost:4000/api/manufactur/fetchElementData"; // New API for elements
