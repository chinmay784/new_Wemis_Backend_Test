...
function AdminElementAsignList() {
  ...
  const fetchAssignedData = async () => {
    try {
      const response = await axios.post(
        " http://localhost:4000/admin/fetchAllDaterelatedToassignAdminElement",
        {},
  ...
  const fetchElementsAndWlps = async () => {
    try {
      const response = await axios.post(
        " http://localhost:4000/admin/fetchAllAvailableElementsAndWlps",
        {},
        { headers: { Authorization: `Bearer ${tkn}` } }
      );
      setElements(response.data?.adminElementList || []);
  ...
  const handleAssign = async () => {
    ...
    try {
      await axios.post(
        " http://localhost:4000/admin/adminAssignElement",
  ...
  const fetchWlpAssignElementList = async () => {
    try {
      const response = await axios.post(
        " http://localhost:4000/admin/fetchWlpAssignElementList",
        {},
        { headers: { Authorization: `Bearer ${tkn}` } }
      );
