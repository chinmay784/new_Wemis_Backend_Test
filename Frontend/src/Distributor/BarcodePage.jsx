...
function BarcodePage() {
  ...
  const fetchMetaData = async () => {
    try {
      const res = await axios.post(
        "http://localhost:4000/api/manufactur/fetchAllAssignElementDataRelatedToCreateBarCode",
        {},
  ...
  const fetchBarcodeData = async () => {
    ...
    try {
      const res = await axios.post(
        "http://localhost:4000/api/manufactur/fetchAllBarCode",
        {},
        { headers: { Authorization: `Bearer ${tkn}` } }
      );
  ...
  const handleCreateSubmit = async (e) => {
    ...
    try {
      const response = await axios.post(
        "http://localhost:4000/api/manufactur/createBarCode",
        formData,
        { headers: { Authorization: `Bearer ${tkn}` } }
      );
